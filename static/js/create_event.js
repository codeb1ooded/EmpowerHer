...
$(function(){
    ...
    $('.colins-submit').on('click', function(e) {
        ...
        var reg_close_date = $("#reg_close_date").val();
        var event_start_date = $("#event_start_date").val();
        var event_close_date = $("#event_close_date").val();
        var details = $("#details").val();
        var website = $("#website").val();
        var email = $("#email").val();
        var location = $("#location").val();
        $.get('/create_event/', {event_id: event_id, name:name, description:description, reg_start_date:reg_start_date,
                                    reg_close_date:reg_close_date, event_start_date:event_start_date,
                                    event_close_date:event_close_date, details:details, website:website,
                                    location: location}, function(data){
                                        event_id = data;
                                    });
    });
